...
export default async function Matte() {
  return (
    <main className="bg-[#282B2A] text-white">
      <VideoHero />
      <div className="h-screen flex items-center justify-center mb-[50vh]">
        <h1 className="text-4xl font-serif font-medium text-center text-balance leading-normal">
          The Free Shepherd is an atmospheric adventure where you are a sheepdog in a mystical world, searching for your
          lost sheep.
        </h1>
      </div>
      <VideoScrollMatteSnap />
      <div className="h-screen"></div>
      <div id="trailer" className="bg-[#282B2A] relative z-2 h-screen flex items-center justify-center">
        <BlurUp className="w-[80%] max-w-[960px]">
          <iframe
      ...
      <div id="newsletter" className="bg-[#282B2A] relative z-2 h-screen flex items-center justify-center">
        <BlurUp className="flex flex-col gap-8 items-center">
          <h2 className="text-2xl font-serif">Newsletter signup</h2>
          <MailchimpScript />
        </BlurUp>
      </div>
      <div className="bg-[#282B2A] relative z-2 h-screen p-16 flex items-center justify-center">
        <BlurUp className="flex flex-col gap-8 items-center">
